...
func (e *Eth) GetCode(addr web3.Address, block web3.BlockNumberOrHash) (string, error) {
	var res string
	if err := e.Client.Call("eth_getCode", &res, addr, block.Location()); err != nil {
		return "", err
	}
	return res, nil
}
...
func (e *Eth) GetStorageAt(addr web3.Address, slot web3.Hash, block web3.BlockNumberOrHash) (web3.Hash, error) {
	var hash web3.Hash
	err := e.Client.Call("eth_getStorageAt", &hash, addr, slot, block.Location())
	return hash, err
}
...
func (e *Eth) GetFilterChanges(id string) ([]*web3.Log, error) {
	var raw string
	err := e.Client.Call("eth_getFilterChanges", &raw, id)
	if err != nil {
		return nil, err
	}
	var res []*web3.Log
...
func (e *Eth) NewFilter(filter *web3.LogFilter) (string, error) {
	var id string
	err := e.Client.Call("eth_newFilter", &id, filter)
	return id, err
}
...
func (e *Eth) NewBlockFilter() (string, error) {
	var id string
	err := e.Client.Call("eth_newBlockFilter", &id, nil)
	return id, err
}
...
func (e *Eth) UninstallFilter(id string) (bool, error) {
	var res bool
	err := e.Client.Call("eth_uninstallFilter", &res, id)
	return res, err
}
...
func (e *Eth) GetNonce(addr web3.Address, blockNumber web3.BlockNumberOrHash) (uint64, error) {
	var nonce string
	if err := e.Client.Call("eth_getTransactionCount", &nonce, addr, blockNumber.Location()); err != nil {
		return 0, err
	}
...
func (e *Eth) GetBalance(addr web3.Address, blockNumber web3.BlockNumberOrHash) (*big.Int, error) {
	var out string
	if err := e.Client.Call("eth_getBalance", &out, addr, blockNumber.Location()); err != nil {
		return nil, err
	}

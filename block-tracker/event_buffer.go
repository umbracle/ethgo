...
func (b *eventBuffer) Append(events *BlockEvent) {
...
func newSentinelItem() *bufferItem {
	return newBufferItem(&BlockEvent{})
}
...
func newBufferItem(events *BlockEvent) *bufferItem {
	return &bufferItem{
		link: &bufferLink{

...
The `wallet` package is an implementation of the [Signer](./signer) abstraction using a private key. It supports loading the private key from different mediums.
